...
describe('Documents RBAC metadata', () => {
  it('upload + request-signature require documents:create; reads require documents:view', () => {
  ...
  it('sign + cancel carry NO RBAC metadata (recipient / row-level gated — "any recipient")', () => {
